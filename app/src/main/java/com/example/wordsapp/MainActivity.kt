...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /**
         * 1 way of setting recyclerView
         */
//        recyclerView.layoutManager = LinearLayoutManager(this)
//        recyclerView.adapter = LetterAdapter(this)

        /**
         * 2 way of setting recyclerView
         */
        chooseLayout()
    }
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        outState.putBoolean("isLinearLayout", isLinearLayoutManager)
        super.onSaveInstanceState(outState)
    }

    override fun onRestoreInstanceState(savedInstanceState: Bundle) {
        isLinearLayoutManager = savedInstanceState.getBoolean("isLinearLayout")
        chooseLayout()
